...
public class GeepModel<T extends Geep> extends QuadrupedModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        return createLayer(lefH, 0, legDef, bodyDef);
    }
    ...
    private static LayerDefinition createLayer(int lefOffset, int widthIncrement, CubeDeformation legDef, CubeDeformation bodyDef) {
        ...
        partDefinition.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-4.0F - widthIncrement, -0.0F, -8.0F, 8.0F + 2 * widthIncrement, 9, 16, bodyDef),
    ...
    public static LayerDefinition createFurLayer() {
        ...
        return createLayer(lefH, 1, legDef, bodyDef);
    }
